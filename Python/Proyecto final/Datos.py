...
class DatosCombos:
    def __init__(self, id_producto, nombre_producto, lista, precio_compra_producto, precio_venta_producto, cantidad_producto):
        self.id_producto = id_producto
        self.nombre_producto = nombre_producto
        self.lista = lista
        self.precio_compra_producto = precio_compra_producto
    ...
    def obtener_datos_producto(self):
        return self.id_producto, self.nombre_producto, self.lista, self.precio_compra_producto, self.precio_venta_producto, self.cantidad_producto